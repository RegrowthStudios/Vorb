function init()
  ...
  -- Test Button
  b1 = Form.makeButton("Button1", 40, 40, 100, 100)
  ...
  b2 = Form.makeButton("Button2", 40, 40, 100, 100)
  ...
  b3 = Form.makeButton("Button3", 40, 40, 100, 100)
  ...
  b4 = Form.makeButton("Button4", 40, 40, 100, 100)
  ...
  b5 = Form.makeButton("Button5", 40, 40, 100, 100)
