...
static struct {
    void(*lock)(void*);
    void(*unlock)(void*);
} __lua_lock_mechanism = {NULL, NULL};

LUA_API void lua_setLock(void(*lock_)(void*)) { __lua_lock_mechanism.lock = lock_; }
LUA_API void lua_setUnlock(void(*unlock_)(void*)) { __lua_lock_mechanism.unlock = unlock_; }

void __lua_lock(void* L) { if (__lua_lock_mechanism.lock != NULL) __lua_lock_mechanism.lock(L); }
void __lua_unlock(void* L) { if (__lua_lock_mechanism.unlock != NULL) __lua_lock_mechanism.unlock(L); }
