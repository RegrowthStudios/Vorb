...
namespace vorb {
    ...
    /** \brief Vorb's mod submodule.
     * 
     * This handles storing all necessary data for each mod, as well as loading,
     * unloading and managing CPU-time of mods.
     */
    namespace mod {
    }
...
#define DECL_VMOD(...) namespace vorb { namespace mod { __VA_ARGS__; }  }
