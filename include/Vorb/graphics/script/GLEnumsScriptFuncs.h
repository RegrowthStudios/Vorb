...
/*! \file GLEnumsScriptFuncs.h
* \brief Registers functions and consts for GLEnums to a script environment.
*/

#pragma once

#ifndef Vorb_GLEnumsScriptFuncs_h__
//! @cond DOXY_SHOW_HEADER_GUARDS
#define Vorb_GLEnumsScriptFuncs_h__
//! @endcond
...
void vg::GLEnumsScriptFuncs::registerConsts(vscript::IEnvironment<ScriptEnvironmentImpl>* env) {
    ...
    // vg::TextureFormat
    env->setNamespaces("Graphics", "TextureFormat");
    ...
    // vg::TexturePixelType
    env->setNamespaces("Graphics", "TexturePixelType");
    ...
    // vg::TextureTarget
    env->setNamespaces("Graphics", "TextureTarget");
...
#endif // !Vorb_GLEnumsScriptFuncss_h__
