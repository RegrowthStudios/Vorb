...
/*! \file TextureCacheScriptFuncs.hpp
* \brief Registers functions and consts for texture cache to script environment.
*/

#pragma once

#ifndef Vorb_TextureCacheScriptFuncs_hpp__
//! @cond DOXY_SHOW_HEADER_GUARDS
#define Vorb_TextureCacheScriptFuncs_hpp__
//! @endcond
...
template <typename ScriptEnvironmentImpl>
void vg::impl::TextureCacheScriptFuncs::registerFuncs(vscript::IEnvironment<ScriptEnvironmentImpl>* env, TextureCache* cache) {
...
template <typename ScriptEnvironmentImpl>
void vg::impl::TextureCacheScriptFuncs::registerConsts(vscript::IEnvironment<ScriptEnvironmentImpl>*) {
    // Empty
}

#endif // !Vorb_TextureCacheScriptFuncs_hpp__
