    ...
    namespace ui {
        ...
        public:
            ...
            virtual void init(
                ...
                init(ownerScreen, window, ioManager, textureCache, fontCache, spriteBatch, nullptr, "");
            }
            /*!
             * \brief Initialises the UI with the necessary services to acquire files, textures, render fonts and othe spritesm etc.
             *
            ...
            void init(
                ...
                UIBase::init(ownerScreen, window, ioManager, textureCache, fontCache, spriteBatch);
