...
namespace vorb {
    namespace ui {
         ...
         */
        bool parseButtonEntry(keg::ReadContext& context, Button* button, const nString& name, keg::Node value, Delegate<IWidget*, const nString&, keg::Node>* widgetParser, vg::FontCache* fontCache, vg::TextureCache* textureCache);
    }
}
