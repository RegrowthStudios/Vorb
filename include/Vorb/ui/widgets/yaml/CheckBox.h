...
namespace vorb {
    namespace ui {
         ...
         */
        bool parseCheckBoxEntry(keg::ReadContext& context, CheckBox* checkBox, const nString& name, keg::Node value, Delegate<IWidget*, const nString&, keg::Node>* widgetParser, vg::FontCache* fontCache, vg::TextureCache* textureCache);
    }
}
