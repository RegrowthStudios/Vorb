...
namespace vorb {
    namespace ui {
         ...
         */
        bool parseSliderEntry(keg::ReadContext& context, Slider* button, const nString& name, keg::Node value, Delegate<IWidget*, const nString&, keg::Node>* widgetParser, vg::TextureCache* cache);
    }
}
