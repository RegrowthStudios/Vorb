...
namespace vorb {
    namespace ui {
         ...
         */
        bool parseWidgetListEntry(keg::ReadContext& context, WidgetList* widgetList, const nString& name, keg::Node value, Delegate<IWidget*, const nString&, keg::Node>* widgetParser, vg::TextureCache* cache);
    }
}
