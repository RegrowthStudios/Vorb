...
namespace vorb {
    namespace math {
        ...
        */
        ...
        inline T easeInBack(T startVal, T finalVal, T alpha, U s = 1.70158f) {
        ...
        template <typename T, typename U = f32>
        inline T easeInBack(T startVal, T finalVal, ui16 stageCount, ui16 stage, U s = 1.70158f) {
            vorb_assert(stageCount != 0, "Stage count must be greater than 0.");
            return easeInBack(startVal, finalVal, (T)stage / (T)stageCount, s);
        }
        template <typename U = f32>
        inline f32v2 easeInBack(f32v2 startVal, f32v2 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f32v2(easeInBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInBack(startVal.y, finalVal.y, stageCount, stage, s));
        }
        template <typename U = f32>
        inline f32v3 easeInBack(f32v3 startVal, f32v3 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f32v3(easeInBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInBack(startVal.y, finalVal.y, stageCount, stage, s),
                easeInBack(startVal.z, finalVal.z, stageCount, stage, s));
        }
        template <typename U = f32>
        inline f32v4 easeInBack(f32v4 startVal, f32v4 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f32v4(easeInBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInBack(startVal.y, finalVal.y, stageCount, stage, s),
                easeInBack(startVal.z, finalVal.z, stageCount, stage, s),
                easeInBack(startVal.w, finalVal.w, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v2 easeInBack(f64v2 startVal, f64v2 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f64v2(easeInBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInBack(startVal.y, finalVal.y, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v3 easeInBack(f64v3 startVal, f64v3 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f64v3(easeInBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInBack(startVal.y, finalVal.y, stageCount, stage, s),
                easeInBack(startVal.z, finalVal.z, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v4 easeInBack(f64v4 startVal, f64v4 finalVal, ui16 stageCount, ui16 stage, U s) {
        ...
        */
        template <typename T, typename U = f32>
        inline T easeOutBack(T startVal, T finalVal, T alpha, U s = 1.70158) {
        ...
        template <typename T, typename U = f32>
        inline T easeOutBack(T startVal, T finalVal, ui16 stageCount, ui16 stage, U s = 1.70158) {
            vorb_assert(stageCount != 0, "Stage count must be greater than 0.");
            return easeOutBack(startVal, finalVal, (T)stage / (T)stageCount, s);
        }
        template <typename U = f32>
        inline f32v2 easeOutBack(f32v2 startVal, f32v2 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f32v2(easeOutBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeOutBack(startVal.y, finalVal.y, stageCount, stage, s));
        }
        template <typename U = f32>
        inline f32v3 easeOutBack(f32v3 startVal, f32v3 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f32v3(easeOutBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeOutBack(startVal.y, finalVal.y, stageCount, stage, s),
                easeOutBack(startVal.z, finalVal.z, stageCount, stage, s));
        }
        template <typename U = f32>
        inline f32v4 easeOutBack(f32v4 startVal, f32v4 finalVal, ui16 stageCount, ui16 stage, U s) {
        ...
        template <typename U = f64>
        inline f64v2 easeOutBack(f64v2 startVal, f64v2 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f64v2(easeOutBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeOutBack(startVal.y, finalVal.y, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v3 easeOutBack(f64v3 startVal, f64v3 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f64v3(easeOutBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeOutBack(startVal.y, finalVal.y, stageCount, stage, s),
                easeOutBack(startVal.z, finalVal.z, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v4 easeOutBack(f64v4 startVal, f64v4 finalVal, ui16 stageCount, ui16 stage, U s) {
        ...
        */
        template <typename T, typename U = f32>
        inline T easeInOutBack(T startVal, T finalVal, T alpha, U s = 1.70158) {
        ...
        template <typename T, typename U = f32>
        inline T easeInOutBack(T startVal, T finalVal, ui16 stageCount, ui16 stage, U s = 1.70158) {
            vorb_assert(stageCount != 0, "Stage count must be greater than 0.");
            return easeInOutBack(startVal, finalVal, (T)stage / (T)stageCount, s);
        }
        template <typename U = f32>
        inline f32v2 easeInOutBack(f32v2 startVal, f32v2 finalVal, ui16 stageCount, ui16 stage, U s) {
        ...
        template <typename U = f32>
        inline f32v3 easeInOutBack(f32v3 startVal, f32v3 finalVal, ui16 stageCount, ui16 stage, U s) {
        ...
        template <typename U = f32>
        inline f32v4 easeInOutBack(f32v4 startVal, f32v4 finalVal, ui16 stageCount, ui16 stage, U s) {
        ...
        template <typename U = f64>
        inline f64v2 easeInOutBack(f64v2 startVal, f64v2 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f64v2(easeInOutBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInOutBack(startVal.y, finalVal.y, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v3 easeInOutBack(f64v3 startVal, f64v3 finalVal, ui16 stageCount, ui16 stage, U s) {
            return f64v3(easeInOutBack(startVal.x, finalVal.x, stageCount, stage, s),
                easeInOutBack(startVal.y, finalVal.y, stageCount, stage, s),
                easeInOutBack(startVal.z, finalVal.z, stageCount, stage, s));
        }
        template <typename U = f64>
        inline f64v4 easeInOutBack(f64v4 startVal, f64v4 finalVal, ui16 stageCount, ui16 stage, U s) {
