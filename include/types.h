...
/*!
 * \typedef vorb::Vector2<ui16> ui16v2
 *
...
/*!
 * \typedef vorb::Vector2<ui32> ui32v2
 *
...
/*!
 * \typedef vorb::Vector2<ui64> ui64v2
 *
...
/*!
 * \typedef vorb::Vector3<ui16> ui16v3
 *
...
/*!
 * \typedef vorb::Vector3<ui32> ui32v3
 *
...
/*!
 * \typedef vorb::Vector3<ui64> ui64v3
 *
...
/*!
 * \typedef vorb::Vector4<ui16> ui16v4
 *
...
/*!
 * \typedef vorb::Vector4<ui32> ui32v4
 *
...
/*!
 * \typedef vorb::Vector4<ui64> ui64v4
 *
...
/*!
 * \typedef vorb::Quaternion<f32> f32q
 *
...
/*!
 * \typedef vorb::Quaternion<f64> f64q
 *
...
/*!
 * \def ENUM_CLASS_OP_INL(CLASS, PROXY_TYPE, OP)
 *
 * \brief Implements a binary operator for an enum class.
 *  
 *  The operator performs its operation using an operator that is defined for a different proxy
 *  type. The enum value is first converted to the proxy type, the operation is performed, and
 *  then the proxy result is converted back to the enum type.
 *
...
/*!
 * \def ENUM_CLASS_OPS_INL(CLASS, PROXY_TYPE)
 *
 ...
 * \class EBox
 *
 * \brief A simple wrapper class over an enum to box it.
 *
...
public:
    ...
    /*!
     * \fn explicit operator EBox::Integral() const
     *
    ...
    /*!
     * \fn operator EBox::bool() const
     *
     * \brief Test the value against zero.
     *
     * \return True if the underlying integral value is non-zero.
     */
    operator bool() const {
...
/*!
 * \fn template<typename T> EBox<T> eBox(T v)
 *
 ...
 * \def offsetptr(s, m)
 *
 * \brief Pointer offset calculation.
 *  
 *  Converts the integral offset value of a member into a pointer representation.
 *
 * \param s The type.
 * \param m The member of the type.
 */
#define offsetptr(s, m) ((void*)offsetof(s, m))

/*!
 * \fn template<typename T, typename U> size_t offsetMember(U T::*member)
 *
 * \brief Member offset calculation.
 *
 * \tparam T The type.
 * \tparam U The type of the member.
 * \param [in] member Pointer to the member in the type.
 *
 * \return Integral offset of the member into the type.
 */
