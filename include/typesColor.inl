...
public:
    /*!
     * \fn ColorRGB8(ui8 r, ui8 g, ui8 b)
     *
    ...
    /*!
     * \fn explicit ColorRGB8(i32 r, i32 g, i32 b)
     *
    ...
    /*!
     * \fn explicit ColorRGB8(f32 r, f32 g, f32 b)
     *
     * \brief Construct a color from floating point values.
     *  
     *  Values experience a conversion to ui8 elements via static_cast<ui8>(value * 255.0f). It is
     *  recommended that floating point values fall within the range [0.0f, 1.0f].
     *
     * \param r Red value.
     * \param g Green value.
     * \param b Blue value.
    ...
    /*!
     * \fn const ui8& operator[] (const size_t& i) const
     *
    ...
    /*!
     * \fn ui8& operator[] (const size_t& i)
     *
     * \brief Access a color element by its index.
     *  
     *  No range checks are performed on the index argument.
    ...
    /*!
     * \fn void lerp(const ColorRGB8& ca, const ColorRGB8& cb, f32 ratio)
     *
    ...
    /*!
     * \fn bool operator==(const ColorRGB8& rhs) const
     *
     * \brief Equality operator for colors.
     *
     * \param rhs The other color.
     *
     * \return True if the all the color elements are the same.
     */
...
public:
    /*!
     * \fn ColorRGBA8(ui8 r, ui8 g, ui8 b, ui8 a = 0xffu)
     *
     * \brief Construct a color with 8-bit RGB elements.
     *
     * \param r Red value.
    ...
    /*!
     * \fn explicit ColorRGBA8(i32 r, i32 g, i32 b, i32 a = 255)
     *
     * \brief Construct a color from integer values.
     *  
     *  Values experience a conversion to ui8 elements via C-Style cast (ui8)value.
     *
     * \param r Red value.
     * \param g Green value.
     * \param b Blue value.
    ...
    /*!
     * \fn explicit ColorRGBA8(f32 r, f32 g, f32 b, f32 a = 1.0f)
     *
     * \brief Construct a color from floating point values.
     *  
     *  Values experience a conversion to ui8 elements via (ui8)(value * 255.0f). It is
     *  recommended that floating point values fall within the range [0.0f, 1.0f].
     *
     * \param r Red value.
     * \param g Green value.
    ...
    /*!
     * \fn void lerp(const ColorRGBA8& ca, const ColorRGBA8& cb, f32 ratio)
     *
    ...
    /*!
     * \fn bool operator==(const ColorRGBA8& rhs) const
     *
     * \brief Equality operator for colors.
     *
     * \param rhs The other color.
