...
namespace vorb {
    namespace voxel {
        ...
        const ui32 DEFAULT_CHUNK_SIZE = 32 * 32 * 32;
        ...
        template<typename T, size_t SIZE = DEFAULT_CHUNK_SIZE>
        class SmartHandle {
        ...
        public:
            ...
            *
            * @param state: Determines if compression or flat array should be used.
            */
             ...
             * 
             * @param state: Determines if compression or flat array should be used.
             * @param value: Value to initialize all voxel data to.
             */
            inline void init(VoxelStorageState state, T value) {
                _state = state;
                if (_state == VoxelStorageState::FLAT_ARRAY) {
                    _dataArray = _arrayRecycler->create();
            ...
            /// The number of voxels should add up to the size
        ...
        private:
            ...
            inline void compress(std::mutex& dataLock) {
                ...
                IntervalTree<T>::LNode data[SIZE];
                int index = 0;
            ...
            vcore::FixedSizeArrayRecycler<SIZE, T>* _arrayRecycler = nullptr; ///< For recycling the voxel arrays
        };
