...
void vg::ShaderManager::triggerShaderCompilationError(Sender s [[maybe_used]], const nString& n) {
    onShaderCompilationError(n);
}

void vg::ShaderManager::triggerProgramLinkError(Sender s [[maybe_used]], const nString& n) {
