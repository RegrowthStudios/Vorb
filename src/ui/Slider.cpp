...
void vui::Slider::onMouseDown(Sender s [[maybe_unused]], const MouseButtonEvent& e) {
    if (m_isMouseIn) {
        MouseDown(e);
        m_isClicking = true;
    }
...
void vui::Slider::onMouseUp(Sender s [[maybe_unused]], const MouseButtonEvent& e) {
    if (m_isMouseIn) {
        MouseUp(e);
...
void vui::Slider::onMouseMove(Sender s [[maybe_unused]], const MouseMotionEvent& e) {
