...
void vui::WidgetScriptFuncs::setDestRect(Widget* w, const f32v4& destRect) const {
    w->setDestRect(destRect);
}

void vui::WidgetScriptFuncs::setDimensions(Widget* w, const f32v2& dims) const {
...
void vui::WidgetScriptFuncs::setPosition(Widget* w, const f32v2& pos) const {
    w->setPosition(pos);
}
...
void vui::WidgetScriptFuncs::setMinSize(Widget* w, const f32v2& minSize) const {
    w->setMinSize(minSize);
}

void vui::WidgetScriptFuncs::setMaxSize(Widget* w, const f32v2& maxSize) const {
    w->setMaxSize(maxSize);
}

void vui::WidgetScriptFuncs::setPositionPercentage(Widget* w, const f32v2& positionPercentage) const {
    w->setPositionPercentage(positionPercentage);
}

void vui::WidgetScriptFuncs::setDimensionsPercentage(Widget* w, const f32v2& dimensionsPercentage) const {
